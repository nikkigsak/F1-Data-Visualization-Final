...
# 2019 Max Verstappen
mv_2019 <- sankeyNetwork(Links = links_driver_mv_19, Nodes = nodes, Source = "source",
...
# 2021 Max Verstappen
mv_2021 <- sankeyNetwork(Links = links_driver_mv_21, Nodes = nodes, Source = "source",
              Target = "target", Value = "value", 
              NodeID = "nodes", colourScale=my_color_1, LinkGroup = "full_name",
              NodeGroup = NULL)
...
# 2019 Lewis Hamilton
lh_2019 <- sankeyNetwork(Links = links_driver_lh_19, Nodes = nodes, Source = "source",
              Target = "target", Value = "value", 
...
# 2021 Lewis Hamilton
lh_2021 <- sankeyNetwork(Links = links_driver_lh_21, Nodes = nodes, Source = "source",
              Target = "target", Value = "value", 
              NodeID = "nodes", colourScale=my_color_0, LinkGroup = "full_name",
              NodeGroup = NULL)
