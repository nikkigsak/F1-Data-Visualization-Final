---
title: "Group F: Comparing the 2019 and the 2021 Formula One Seasons"
subtitle: "GR5063: Data Visualization Final Project"
author: "Lauren Deitz, Donald Stephens, Nikki Gerjarusak, Christa Chiao"
date: "5/10/2022"
...
Formula 1 is the highest class of single-driver racing. There are ten teams and twenty drivers that compete during a Formula 1 season, although, occasionally backup drivers take the place of main drivers if a driver is sick, or otherwise unavailable. Formula 1 drivers and teams travel all over the country to participate in Grand Prix races, which are, at minimum 190 miles. A Formula 1 season can consistent of up to 22 races in the same number of countries, although there are a number of historical circuits that are significant to the Formula 1 sport, including the Monaco Grand Prix (160 miles) and the National Motor Racetrack of Monza (190 miles). 

The aim of Formula 1 drivers and teams are to compete at the highest level and during the course of the season, earn points towards two main trophies: the Constructor's Championship and the Driver's Championship. Points are earned according to race performance, with the top 10 placing drivers and constructors each earning 25 points for first place, 18 points for second place, 15 points for third place, and so on and so forth, all the way down to tenth place, whose driver and constructor each earn a single point. There are other miscellaneous points earnings that are given for the driver who records the fastest lap of the race (+1 point), and for Sprint Races that take place before the Grand Prix on a handful of weekends during the season.

Formula 1 is perhaps best explained by the drivers in the sport:

<Embed Video>



### Where do Formula 1 races take place? 

Formula 1 races take place all over the world, with circuits on all continents (except Antarctica!) and in many major cities. This map shows the placement of all Formula 1 circuits that have been used since the beginnings of the sport in 1950. 

As you can see, the circuits are heavily concentrated in Europe, where the sport got its beginnings, although Formula 1 is gaining in popularity around the world and circuits are built and included in the Formula 1 calendar as that enthusiasm grows. 
...
Formula 1 drivers often get their start early in life, rising in the ranks of Go-Kart ("Karting") racing. The 2021 Formula 1 champion, Max Verstappen, got his start karting at age four-and-a-half. This table contains *all* drivers from the inaugural 1950 season of Formula 1 to the most recent complete season, in 2021. The table contains a link to that driver's Wikipedia page for more biographical and performance background.
...
## The 2019 Formula 1 Season versus the 2021 Formula 1 Season
...
Constructors earn points in the same cadence as drivers, with the first place Constructor earning 25 points, the second place Constructo earning 18 points, and so on and so forth. 
```{r, echo=FALSE, eval=TRUE, include=TRUE, message=FALSE, warning=FALSE, cache = FALSE}
